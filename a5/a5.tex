...
For example, for 3 points, and selecting $x_2, x_3$, the centroid is at $(0,1/2,1/2)$ The distance of the centroid from $x_2,x_3$ is $\sqrt{(2/3)^2+(1/3)^2} = \sqrt{5/9} = R$. However, $x_1$ is at distance $\sqrt{1 + (1/3)^2 + (1/3)^2} > R$.
